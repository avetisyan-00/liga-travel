...
var _slideHero = require("./modules/slide-hero");
var _slideTours = require("./modules/slide-tours");
var _slideTrain = require("./modules/slide-train");
var _slideReview = require("./modules/slide-review");
var _slideAdvantages = require("./modules/slide-advantages");
var _slideGallery = require("./modules/slide-gallery");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.findVideos)();
  (0, _menu.menuToggle)();
  (0, _slideHero.initSliderHero)();
  (0, _slideTours.initSliderTours)();
  (0, _slideTrain.initSliderTrain)();
  (0, _slideReview.initSliderReview)();
  (0, _slideAdvantages.initSliderAdvantages)();
  (0, _slideGallery.initSliderGallery)();
  // Modules
  // ---------------------------------
...
},{".//video":22,"./modules/form-validate/form":3,"./modules/menu":9,"./modules/modals/init-modals":10,"./modules/slide-advantages":12,"./modules/slide-gallery":13,"./modules/slide-hero":14,"./modules/slide-review":15,"./modules/slide-tours":16,"./modules/slide-train":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
exports.initSliderAdvantages = initSliderAdvantages;
var sliderAdvantages = document.querySelector('.advantages__blocks');
...
exports.initSliderGallery = void 0;
var sliderGallery = document.querySelector('.gallery__slider');
var initSliderGallery = exports.initSliderGallery = function initSliderGallery() {
  if (sliderGallery) {
    // eslint-disable-next-line
...
var sliderHero = document.querySelector('.hero');
var initSliderHero = exports.initSliderHero = function initSliderHero() {
  if (sliderHero) {
    // eslint-disable-next-line
...
exports.initSliderReview = void 0;
var sliderReview = document.querySelector('.review__blocks');
var initSliderReview = exports.initSliderReview = function initSliderReview() {
  if (sliderReview) {
    // eslint-disable-next-line
...
exports.initSliderTours = void 0;
var sliderTours = document.querySelector('.tours__slider');
var initSliderTours = exports.initSliderTours = function initSliderTours() {
  if (sliderTours) {
    // eslint-disable-next-line
...
exports.initSliderTrain = void 0;
var sliderTrain = document.querySelector('.train__instructor');
var initSliderTrain = exports.initSliderTrain = function initSliderTrain() {
  if (sliderTrain) {
    // eslint-disable-next-line
...
function setupVideo(video) {
  ...
  var button = video.querySelector('.hero__video-play');
